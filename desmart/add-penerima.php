        ...
        <form action="add-penerima.php" method="POST" enctype="multipart/form-data" name="penerima">
            <table>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><input type="number" name="password" required autocomplete="off"></td>
                </tr>
                </div>
                <div class="tgl">
                <tr>
            ...
            include("koneksi.php");
                if(isset($_POST['proses'])){
                    ...
                    $result = "INSERT INTO penerima(nik,nama,password,tgl_lahir,pekerjaan,id_admin) values
                    ('$nik', '$nama','$password','$tgl_lahir', '$pekerjaan', '$id_admin')";
